...
const ThanksPartyInquiry: React.FC = () => {
        return (
          <Layout>
            <Head>
              <title>Party Request Successful!</title>
            </Head>
            <Nav />
            <Flex
              direction={'column'}
            ...
            >
              ...
              <BlurIn>
                <Text
                  ...
                  // color="primary"
                  >
                  Thanks for requesting a party.
                  </Text>
              </BlurIn>
              <FadeDown>
                <Text h4 css={{ textAlign: 'center' }}>
                    We appreciate your interest in having a party at NWA Pinball. We will reach out to you soon.
      ...
      export default ThanksPartyInquiry;